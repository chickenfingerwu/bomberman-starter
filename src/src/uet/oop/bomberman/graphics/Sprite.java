...
public class Sprite {
	...
	public static Sprite player_right_flamepass = new Sprite("player_right_flame_pass.png", 10, 16);
	public static Sprite player_left_flamepass = new Sprite("player_left_flame_pass.png", 10, 15);
	public static Sprite player_up_flamepass = new Sprite("player_up_flame_pass.png", 12, 16);
	public static Sprite player_down_flamepass = new Sprite("player_down_flame_pass.png", 12, 15);



	public static Sprite player_right_flamepass_1 = new Sprite("player_right_1_flame_pass.png", 12, 16);
	public static Sprite player_right_flamepass_2 = new Sprite("player_right_2_flame_pass.png", 12, 16);


	public static Sprite player_up_flamepass_1 = new Sprite("player_up_1_flame_pass.png", 12, 16);
	public static Sprite player_up_flamepass_2 = new Sprite("player_up_2_flame_pass.png", 12, 15);


	public static Sprite player_left_flamepass_1 = new Sprite("player_left_1_flame_pass.png",11, 16);
	public static Sprite player_left_flamepass_2 = new Sprite("player_left_2_flame_pass.png",12, 16);


	public static Sprite player_down_flamepass_1 = new Sprite("player_down_1_flame_pass.png", 12, 15);
	public static Sprite player_down_flamepass_2 = new Sprite("player_down_2_flame_pass.png", 12, 16);
	/*
	|--------------------------------------------------------------------------
	| Character
	|--------------------------------------------------------------------------
	...
	public Sprite(String path, int rw, int rh) {
		BufferedImage load_sprite = null;
		try {
			URL a = new File("res/sprites/" + path).toURI().toURL();
			load_sprite = ImageIO.read(a);
		}catch (IOException e){
			e.printStackTrace();
		}
		_realHeight = rh;
		...
		SIZE = 16;
		_pixels = new int[SIZE * SIZE];
		load_sprite.getRGB(0, 0, 16, 16, _pixels, 0, 16);
	}
	...
	public Sprite(String path) {
		...
		_realHeight = load_sprite.getHeight();
		_realWidth = load_sprite.getWidth();
		SIZE = 16;
		_pixels = new int[SIZE*SIZE];
		load_sprite.getRGB(0, 0, _realWidth, _realHeight, _pixels, 0, _realWidth);
	}
